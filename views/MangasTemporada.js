...
export default function TemporadaScreen({ navigation }) {
	...
	useEffect(() => {
		fetch("https://jikan1.p.rapidapi.com/season/2018/winter", {
			"method": "GET",
			"headers": {
  ...
  return (
	  <View style={{flex: 1, backgroundColor: '#333',	alignItems: 'center', justifyContent: 'center'}}>
		  ...
		  <View style={{justifyContent: 'flex-start', width: '100%', backgroundColor: '#333', flexDirection: 'row'}}>
			  ...
			  <Text style={{alignSelf:'center', marginTop: '5%', marginLeft: '8%', color: 'white', fontSize: 24}}> Mangas da Temporada </Text>
		  </View>
